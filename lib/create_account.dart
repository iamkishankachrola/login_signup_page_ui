      ...
      body: Container(
        ...
        child:  Column(
          ...
          children: [
            ...
            const Text("Welcome! Please enter your details.",style: TextStyle(fontSize: 16,color: Color(0xff8D8E91)),),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.account_circle_outlined,color: Color(0xff8D8E91),),
            ...
            Row(
              children: [
                ...
                const Text("Must be at least 8 characters",style: TextStyle(color:Color(0xff8D8E91),fontSize: 14 ),)
              ],
            ),
            const SizedBox(height: 20,),
            ...
            Row(
              ...
              children: [
                ...
                const Text("Or sign up with",style: TextStyle(color: Color(0xff8D8E91),fontSize: 12),),
                Image.asset("assets/images/line.jpeg",width: 120,height: 1,fit: BoxFit.fill,color:const Color(0xff8D8E91),),
              ],
            ),
            const SizedBox(height: 20,),
            ...
            const Expanded(
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Already have an account?",style: TextStyle(color: Color(0xff8D8E91),fontSize: 14),),
                    SizedBox(width: 5,),
                    InkWell(child: Text("Log in",style: TextStyle(color: Colors.blue,fontSize: 14))),
                  ],
                ),
              ),
            )
